...
class AssigningProblemGAN:
    ...
    def pareto_ranking(self,values, designs, num_pareto_fronts):
        ...
        for _ in range(num_pareto_fronts):
            pareto_front_indices = self.compute_pareto(remaining_values)
            ...
            for i in pareto_front_indices:
                remaining_values[i] = [0, self.cost_max]  # Mark dominated solutions with high cost and zero science
    ...
    def pareto_front_calculator(self, solutions, show, name, save = False, calculate = True):
        ...
        if calculate:
            ...
            pareto_fronts, pareto_designs = self.pareto_ranking(values,designs,self.num_pareto_fronts)
    ...
    def diversity_score(self,data, subset_size=10, sample_times=1000):
